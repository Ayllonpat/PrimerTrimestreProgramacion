...
public class CrudProducto {
	 ...
	 * Ojo, porque no se comprueba nada, se pierde lo que había*///no elegimos la posicion
	...
	public Producto findById(String codigo) {
		...
		while (i < lista.length && !encontrado) {
			...
			if (deLista.getCodigo().equalsIgnoreCase(codigo))//ignora mayusculas y minisculas
				encontrado = true;
			else
				i++;
		}
